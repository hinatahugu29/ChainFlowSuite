...
class PreviewPane(QWidget):
    ...
    def _do_export_with_clean_html(self, raw_result, path):
        ...
        # PDF生成エンジンにローカルファイルアクセス権限を付与（スタンプ等の画像読み込みに必要）
        print_page.settings().setAttribute(QWebEngineSettings.LocalContentCanAccessFileUrls, True)
        ...
        print_page.setHtml(full_print_html, QUrl("file:///"))
