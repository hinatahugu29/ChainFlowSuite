...
class SearchWindow(QMainWindow):
    def __init__(self, start_dir=None):
        ...
        # v23.0 Update: Engine status visibility
        from search_engine import _HAVE_NATIVE_CORE
        engine_tag = "[Native]" if _HAVE_NATIVE_CORE else "[Python]"
        self.setWindowTitle(f"ChainFlow Search v23 {engine_tag}")
