...
class ContextMenuBuilder:
        ...
        for v, p, _, _ in self.pane.views:
            ...
            for idx in indices:
                ...
                if row not in processed_rows:
                    ...
                    all_selected_paths.append(self.pane.base_model.filePath(p.mapToSource(col0_idx)))
    ...
    def _paste(self, ctx):
        ...
        if ctx['index'].isValid():
            p_under_mouse = self.pane.base_model.filePath(ctx['proxy'].mapToSource(ctx['index']))
